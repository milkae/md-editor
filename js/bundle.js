...
var Editor = React.createClass({
	...
	render: function render() {
		return React.createElement('div', null, React.createElement('div', { className: 'view', dangerouslySetInnerHTML: this.rawMarkup() }), React.createElement('textarea', { onChange: this.onChange, ref: 'textarea', defaultValue: this.state.data }));
	}
});
